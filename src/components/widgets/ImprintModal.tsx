      ...
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-1 md:p-4 text-center">
            ...
            >
              <DialogPanel className="w-full max-w-lg transform overflow-hidden rounded-[28px] bg-white dark:bg-dark p-4 text-left align-middle shadow-xl transition-all">
